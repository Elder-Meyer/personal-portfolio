...
export const projects = [
    {
      ...
      techs: ["React js", "Firebase", "Material UI", "mongodb", "emotion", "google analitycs", "leaflet"],
      shortDescription: "Web application of culture.",
      largeDescription: "Website developed like a university project with the purpose of preserve the tradition and culture of Huejutla de Reyes Hgo City, in collaboration with 'La casa de la cultura'",
    ...
    },
    {
      ...
      largeDescription: "this is a large description lorem lorem lorem lorem",
